...
namespace ConsoleIOCUnityDemo.Untiy
{
    /// <summary>
    /// 描 述：UnityIoc
    /// </summary>
...
//            UnityConfigurationSection section = (UnityConfigurationSection)ConfigurationManager.GetSection("unity");
        ...
        /// 容器实例
        /// </summary>
        private static readonly UnityIocHelper aopInstance = new UnityIocHelper("ContainerAOP");
        ...
        public static UnityIocHelper AOPInstance
        {
            get { return aopInstance; }
        }
